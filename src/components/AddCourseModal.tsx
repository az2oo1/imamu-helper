      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200/80 dark:border-zinc-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-stone-100 dark:bg-stone-900/60 border border-[var(--color-imamu-accent)]/20 text-[var(--color-imamu-accent)] flex items-center justify-center shrink-0">
              {fetchedSection ? (
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-zinc-400 font-medium">
                {fetchedSection
                  ? `${sectionNameDisplay} · CRN: ${fetchedSection.crn} · ${currentSemesterObj?.label || 'الفصل الدراسي'}`
                  : selectedSubject
          ...
          <div ref={contentRef} className="p-5 sm:p-6 overflow-y-auto max-h-[calc(85vh-7rem)] custom-scrollbar space-y-5">
            ...
            {fetchedSection && (
              <div className="space-y-5">
                {/* Course Summary Badges & Change CRN */}
                <div className="flex items-center justify-between gap-2 pb-1">
                  <div className="flex flex-wrap items-center gap-1.5">
                    <span className="px-2.5 py-0.5 bg-stone-100 dark:bg-stone-900 text-[var(--color-imamu-accent)] border border-[var(--color-imamu-accent)]/30 text-xs font-bold rounded-lg" dir="ltr">
                      {fetchedSection.courseCode}
                    </span>
                    <span className="px-2.5 py-0.5 bg-stone-100 dark:bg-stone-900 text-slate-700 dark:text-zinc-200 text-xs font-bold rounded-lg">
                      {sectionNameDisplay}
                    </span>
                    <span className="flex items-center gap-1 px-2.5 py-0.5 bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-300 text-xs font-medium rounded-lg">
                      <Clock className="w-3 h-3 text-[var(--color-imamu-accent)]" /> {fetchedSection.creditHours || 3} س
                    </span>
                    <span className="px-2.5 py-0.5 bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-300 text-xs font-medium rounded-lg" dir="ltr">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg border border-slate-200 dark:border-zinc-800 hover:bg-slate-100 dark:hover:bg-zinc-800 text-slate-500 dark:text-zinc-400 text-xs font-bold transition cursor-pointer shrink-0"
                  >
                    تغيير الـ CRN
                  </button>
                </div>
                ...
                <LayoutGroup id="addCourseModalTabs">
                  <div className="relative flex flex-wrap items-center gap-1 border-b border-slate-200 dark:border-zinc-800 mb-4 pb-0">
                    <button
                      type="button"
                      onClick={() => {
                        setActiveTab('overview');
                        ...
                        <div className="flex items-center gap-2 self-start sm:self-center">
                          {customWaLink ? (
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-600/20 border border-emerald-500/40 text-emerald-400 hover:bg-emerald-600/30 text-xs font-bold transition cursor-pointer"
                            >
                              <Plus className="w-3.5 h-3.5" />
                              <span>إضافة رابط القروب</span>
                            </button>
                          )}
                        </div>
                      </div>

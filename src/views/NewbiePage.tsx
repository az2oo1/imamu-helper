...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    summary: 'تلتزم الجامعة بضوابط المظهر العام والزي الرسمي المحتشم، ويمنع أمن الحرم الجامعي دخول أي مخالف للضوابط.',
    points: [
      'للطلاب (المدينة الجامعية): الزي الرسمي المعتمد هو الثوب السعودي (مع الشماغ أو الغترة أو بدونهما). يُمنع منعاً باتاً ارتداء الشورت (السراويل القصيرة)، بناطيل النوم أو الترنجات، الملابس الممزقة، أو الملابس التي تحمل كتابات وشعارات غير لائقة.',
      'الزي الرياضي والمختبرات: يُسمح بالملابس الرياضية المحتشمة حصراً داخل الملاعب والصالات الرياضية، ويُشترط ارتداء المعطف الطبي (Lab Coat) فوق الثوب داخل المعامل والمختبرات العلمية.',
      'للطالبات (مدينة الملك عبدالله): الالتزام بارتداء العباءة المحتشمة والساترة عند البوابات وأثناء التنقل، وارتداء ملابس ساترة ولائقة بالصرح الأكاديمي داخل مباني الكليات مع تجنب الملابس الضيقة أو القصيرة أو الشفافة.'
    ]
  },
  {
    id: 'reward-date',
...
export function NewbiePage() {
  ...
  const checklistItems = [
    ...
    { key: 'dressCode', label: 'الالتزام بالزي الجامعي المعتمد (الثوب السعودي للطلاب، والعباءة المحتشمة للطالبات)' },

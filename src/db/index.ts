...
const SCHEMA_VERIFICATION_STATEMENTS = [
  ...
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS semesters text`,
  ...
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS subject_description text`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS college text`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS college_code text`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS department text`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS department_code text`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS lecture_hours integer`,
  `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS lab_hours integer`,
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_subjects_code_unq ON subjects(code)`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS crn text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS section_number text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS course_title text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS academic_year text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS semester text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS term text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS campus text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS schedule_type text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS instructional_method text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS credit_hours integer`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS is_open boolean`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS max_enrollment integer`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS current_enrollment integer`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS seats_available integer`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS final_exam text`,
  `ALTER TABLE course_sections ADD COLUMN IF NOT EXISTS primary_instructor text`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_sections_academic_year ON course_sections(academic_year)`,
  `CREATE INDEX IF NOT EXISTS idx_sections_semester ON course_sections(semester)`,
  `CREATE INDEX IF NOT EXISTS idx_sections_term ON course_sections(term)`,
  ...
  `ALTER TABLE events ADD COLUMN IF NOT EXISTS calendar_type text DEFAULT 'academic'`,

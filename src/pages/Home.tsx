    ...
    <div className="flex flex-col items-center flex-1 w-full pt-12 pb-16 bg-transparent" dir="rtl">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link to="/tools" className="px-8 py-3.5 rounded-full bg-blue-600 text-white font-medium shadow-sm hover:bg-blue-500 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 w-full sm:w-auto text-center">
            اكتشف الأدوات
          </Link>
          <Link to="/resources" className="px-8 py-3.5 rounded-full bg-transparent border border-zinc-700 text-zinc-200 font-medium hover:bg-zinc-800/50 hover:text-zinc-50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 w-full sm:w-auto text-center">
            تصفح المصادر
          </Link>
        </div>
      </motion.div>

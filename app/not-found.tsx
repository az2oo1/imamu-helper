...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4" dir="rtl">
      <h1 className="text-6xl font-serif font-black text-[var(--color-imamu-accent)] mb-4">404</h1>
      ...
      <Link 
        href="/"
        className="px-6 py-3 bg-[var(--color-imamu-brown)] hover:bg-[var(--color-imamu-brown-dark)] text-white font-bold text-sm rounded-xl transition shadow-md"
      >
